...
type CheckoutRouteProp = RouteProp<ModelsRoutes, "Checkout">;
...
export default function Checkout() {
    ...
    const installmentOptions = Array.from({ length: 12 }, (_, i) => (i + 1).toString());
    ...
    const renderInstallmentOption = ({ item }: { item: string }) => (
        <TouchableOpacity
            style={styles.modalOption}
            onPress={() => {
        ...
        >
            <Text style={styles.modalOptionText}>{`${item}x`}</Text>
        </TouchableOpacity>
    );
    ...
    return (
        <SafeAreaView style={styles.safeArea}>
            ...
            {/* Modal para Informações do Cliente e Pagamento */}
            <Modal
                animationType="slide"
                transparent={true}
                ...
                <View style={styles.modalContainer}>
                    <ScrollView style={styles.modalContent}>
                        ...
                        {paymentType === "Crédito" && (
                            <TouchableOpacity
                                style={styles.paymentSelector}
                                onPress={() => setInstallmentsModalVisible(true)}
                            >
                                <Text style={styles.paymentSelectorText}>
                                    {installments ? `${installments}x` : "Selecione a quantidade de parcelas"}
                                </Text>
                            </TouchableOpacity>
                        )}
                        ...
                        >
                            <View style={styles.modalContainer}>
                                <View style={styles.modalContent}>
                                    <Text style={styles.modalTitle}>Escolha a Quantidade de Parcelas</Text>
                                    <FlatList
                                        data={installmentOptions}
                                        renderItem={renderInstallmentOption}
                                        keyExtractor={(item) => item}
                                    />
                                    <TouchableOpacity
                                        style={styles.closeButton}
                        ...
                        <TouchableOpacity style={styles.submitButton} onPress={handleFinishOrder}>
